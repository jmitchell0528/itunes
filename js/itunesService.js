    ...
    console.log("Service is working");
          ...
          this.getArtist = function(artist) {
            ...
            .then(function(result) {
              ...
              // Eventually we're going to do some formatting
              // Loop through result.data.results
              // For each object, create a new object with changed property names
              // Push new object to a new array
              // Return the new array to deferred.resolve
